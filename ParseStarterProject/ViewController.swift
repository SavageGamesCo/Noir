...
//        commonActionSheet(title: "Beta Test Phase 3: What To Test", message: "WOW! We have come quite a long way guys!\n\n I am so grateful for you all participating in this beta test. We have reached the final stretch! This beta test is simple. Do you see the ads or don't you. Now these are not real ads, but placeholders. The code for the real ads is what is driving this though.\n\n You can try out the in-app purchases just to ensure they go through, no money will be charged, but I also think only my sandbox account can do this, but hey... give it a shot and let me know if it crashes.\n\n After this short phase your accounts will be permanently marked as 'Ad Free'.\n\n Thank you for your support! Now get out there and tell people about Noir! Mobile Dating for Gay People of Color!\n\n ~ Noir Admin  ")
    ...
    func SignUpMode(){
        ...
        commonActionSheet(title: "Terms of Use", message: "Welcome to Noir, Mobile Dating for Gay People of Color and Lovers of Diversity! By clicking 'OK' you are agreeing to and understand the following brief terms of use.\n\n Preface: Noir's goal is to recreate the inclusive environment of the Black nightclubs in 1920's Harlem. The Harlem Nightclubs catered to people of color but everyone was welcome. They were one of the few places where people of color were able to enter through the front door and have services tailored specifically to them. All were welcome, but everyone knew the deal.\n\n As such, racism, racist language and blatant discrimination will not be tolerated.\n\n That said, make no mistake, this is a home for gay people of color. It is a place for us to meet each other, mingle with each other, stay in touch with each other and yes even find a potential date.\n\n The rules are as follows:\n\n * No Nudity on public images.\n\n * No Discriminatory language such as 'No, <insert race/religion/bodytype here>'.\n\n * No Harassament/Cyber Stalking/Cyber Bullying\n\n * No Pornography\n\n * No CatFishing.\n\n Please report ANY profiles that are participating in trolling, cyber bullying, cyber stalking, discriminatory language/activity or other violations of the rules set about. Any violations of the rules can result in everything from a temporary ban to a permanent deletion of your account and loss of your subscription depending on the severity of the offense or frequency of being reported.\n\n Otherwise, enjoy your time here on Noir, Mobile Dating for Gay People of Color and Lovers of Diversity.")
